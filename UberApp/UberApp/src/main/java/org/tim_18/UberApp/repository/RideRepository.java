...
=======
    ...
    @Query(value = "SELECT * FROM rides WHERE rides.driver_id = ?1 and rides.start_time>?2 and rides.end_time<?3 order by ?4", nativeQuery = true)
    Page<Ride> findRidesForDriver(Integer id, LocalDateTime start, LocalDateTime end, Pageable pageable);
>>>>>>> Stashed changes
}
