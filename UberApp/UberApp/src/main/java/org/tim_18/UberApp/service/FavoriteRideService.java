...
public class FavoriteRideService {
    ...
    public FavoriteRideService(FavoriteRideRepository favoriteRideRepository) {
        this.favoriteRideRepository = favoriteRideRepository;
    }

    public List<FavoriteRide> findAll() {
        return this.favoriteRideRepository.findAll();
    }

    public FavoriteRide createFavRide(FavoriteRide ride){
        return this.favoriteRideRepository.save(ride);
    }

    public List<FavoriteRide> findAllByPassenger(Integer passengerId) {
        return this.favoriteRideRepository.findAllByPassenger(passengerId);
    }

//    @Transactional
    public void deleteFavRide(Integer id) {
        this.favoriteRideRepository.deleteFavoriteRideById(id);
    }
