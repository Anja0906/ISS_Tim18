...
public class ReviewService {
    ...
    public Page<Review> findAll(Pageable page){return reviewRepository.findAll(page);}
    public Page<Review> findByRideId(int id, Pageable pageable) {return reviewRepository.findByRideId(id, pageable);}
    public Page<Review> findByDriverId(int id, Pageable pageable) {return reviewRepository.findByDriverId(id, pageable);}
    public Page<Review> findByVehicleId(int id, Pageable pageable) {return reviewRepository.findByVehicleId(id, pageable);}
    public Review addReview(Review review) {return reviewRepository.save(review);}
    public HashSet<Review> findByRideIdHash(Integer id) {return reviewRepository.findByRideIdHash(id);}
